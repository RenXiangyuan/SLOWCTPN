...
data_valid = model_data.get_files_with_ext(meta.dir_images_valid, 'png')[6:10]
print('load finished.')

#
# train
model.train_and_valid(data_train, data_valid, retrain = False)
#
...
#
list_images_valid = model_data.get_files_with_ext(meta.dir_images_valid, 'png', 10)
