...
class ModelDetect():
    ...
    def create_graph_all(self, training):
        ...
        with self.graph.as_default():
            ...
            clipped_grads_and_vars = [(tf.clip_by_norm(grad, 10),
    ...
    def train_and_valid(self, data_train, data_valid, retrain = False):
        #     
        # model save-path
        ...
        with self.graph.as_default():
            ...
            with tf.Session(config = self.sess_config) as sess:
                ...
                #
                if not retrain and ckpt and ckpt.model_checkpoint_path:
                ...
                while step < self.train_steps:
                    ...
                    if step % self.loss_freq == 0:
                        ...
                        print('step: %d, average loss: %g, lr: %g, sect_time: %.1f, total_time: %.1f, %s' %
                              (step, accumulate_loss / (step + 1), lr,
